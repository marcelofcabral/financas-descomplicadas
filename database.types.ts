  ...
  public: {
    Tables: {
      ...
      user_module_recommendations: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_module_recommendations_module_id_fkey"
            columns: ["module_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "user_module_recommendations_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Enums: {
      investor_profile: "beginner" | "intermediate" | "advanced"
    }
    CompositeTypes: {
      [_ in never]: never
    }
